...
overwriteCheck = uicheckbox(tab, 'Position', [120 460 200 22], ...
    ...
    uilabel(tab, 'Position', [440 400 100 22], 'Text', 'Gaussian Sigma:');
    gaussianSigmaEdit = uieditfield(tab, 'numeric', 'Position', [540 400 100 22], 'Value', 4.0);

    uilabel(tab, 'Position', [650 400 100 22], 'Text', 'Gaussian Size:');
    gaussianSizeEdit = uieditfield(tab, 'numeric', 'Position', [750 400 100 22], 'Value', 5);
...
uibutton(tab, 'Position', [20 330 960 30], 'Text', 'Start Spatial Smoothing', ...
    ...
    overwriteCheck, iterationsEdit, dtEdit, lambdaEdit, viscousnessEdit, ...
    surfaceTensionEdit, gaussianSigmaEdit, gaussianSizeEdit, realTimeVisCheck));
end
...
function startSpatialSmoothing(fig, tab, inputDirEdit, outputDirEdit, overwriteCheck, ...
        iterationsEdit, dtEdit, lambdaEdit, viscousnessEdit, ...
        surfaceTensionEdit, gaussianSigmaEdit, gaussianSizeEdit, realTimeVisCheck)
    % Get parameters
    ...
    params.viscousness = viscousnessEdit.Value;
    params.surfaceTension = surfaceTensionEdit.Value;
